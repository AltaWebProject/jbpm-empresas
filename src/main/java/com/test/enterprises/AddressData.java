...
public class AddressData implements java.io.Serializable {
	...
	@javax.persistence.GeneratedValue(strategy = javax.persistence.GenerationType.AUTO, generator = "ADDRESSDATA_ID_GENERATOR")
	@javax.persistence.SequenceGenerator(name = "ADDRESSDATA_ID_GENERATOR", sequenceName = "ADDRESSDATA_ID_SEQ")
